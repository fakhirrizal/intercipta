...
--
-- Host: 127.0.0.1
-- Generation Time: 31 Jul 2019 pada 01.30
...
INSERT INTO `tb_project_region_to_outlet` (`id_project_region_to_outlet`, `id_project_region`, `id_outlet`) VALUES
(1, 1, 1),
(2, 1, 1);
...
CREATE TABLE `tb_shift` (
  `id` int(11) NOT NULL,
  `nama_shift` varchar(13) NOT NULL,
  `jam_masuk` time NOT NULL,
...
INSERT INTO `tb_user` (`id_user`, `nik`, `nama`, `alamat`, `email`, `password`, `nohp`, `level`, `status_absen`, `absen_today`, `id_shift`, `id_region`) VALUES
(1, '3332638713', 'Rayfart Setyobaskoro', 'Jl. Jakarta Selatan', 'rayfart@gmail.com', '$2y$10$wfiL5/fEMyQrVhu0I1qFyu/MfSA/SRbUue7MNldVh/xwt2FAq48f6', '081223895047', 'fl', 'masuk', 'ya', 1, 1),
(2, '3335261816', 'Muhammad Misbahul Munir', 'Tembalang, Jawa Tengah', 'misbah@gmail.com', '$2y$10$.JD.lsQDTN8FfhIRhwrENOn8tI8Ck.Rw/Bg7/KBhBc9g8OWMUQq/a', '087664523870', 'tl', 'keluar', 'tidak', NULL, 1),
(3, '3371638164', 'Deny Prasetyo', 'Tembalang, Jawa Tengah', 'deny@gmail.com', '$2y$10$8ZaEDpaU28knmwrZIEmrUeOZflYp6k0JGizE66DsVQ0BTcvE51Uku', '087664682003', 'pic', 'keluar', 'tidak', NULL, NULL),
(4, '3310349513', 'Nika Agung Wisesa', 'Jl Timoho Barat, Semarang, Jawa Tengah', 'nikaagung@gmail.com', '$2y$10$GXcbPrH3NmaSuOQ2EQK/t.ngQExgJO/q6YmziSvME1PoCjrfRCYM6', '083673173123', 'admin', 'keluar', 'tidak', NULL, NULL),
(5, '3310349514', 'Ricky Reza', 'Jl Bulusan, Tembalang, Semarang', 'rickyreza123@gmail.com', '$2y$10$LZ5xIIfClfS9RixP0VblouJIovaGalwdaRqk8yzaHg2CBjeC/BRpq', '083673173545', 'admin', 'keluar', 'tidak', NULL, NULL),
(6, '3310349515', 'Muhammad Hilal', 'Jl Tirtasari, Tembalang, Semarang', 'muhhilal123@gmail.com', '$2y$10$GjIG64yKzNhp6p96wQ9q6uION7baXIwsycJG0Idu7mzjMvNUHrKea', '083673173324', 'admin', 'keluar', 'tidak', NULL, NULL),
(7, '3310349517', 'Erwyn Syahputra', 'Jl Balur, Banyumas, Jawa Tenhah', 'erwynsyah231@gmail.com', '$2y$10$RLPQzkv/9rbtEG0sY8zCHO4QT.cHmMQHiGLDw005Co45AW5kxSo4e', '083673173565', 'tl', 'keluar', 'tidak', NULL, 1),
(8, '3310349518', 'Roni Herawan', 'Jl Bontang, Tegal, Jawa Tengah', 'roni231@gmail.com', '$2y$10$LdnX6RTuNsrq8T/69dAbnuA1WbF2odkCVE96PLQpnYvm8/qQkBPb6', '083673173575', 'fl', 'keluar', 'tidak', 2, 1),
(9, '3310349590', 'Tanggon Jodi', 'Jl Woltermongensidi, Semarang, Jawa Tengah', 'tanggon123@gmail.com', '$2y$10$n0BY79SzYXeYyzo7uWny7uH2FVIpquUQrxRWExfTFztN.brWFNgiq', '083673173634', 'tl', 'keluar', 'tidak', NULL, 2),
(10, '3341239845', 'Aris Riyanto', 'Jl Randublatung, Blora, Jawa Tengah', 'arisriyanto123@gmail.com', '$2y$10$ngkS2IS4FCxMSEO.946Or.pO8N/h7qqR9v8kwmcCbzbaZwB8lEfeG', '085621452372', 'fl', 'keluar', 'tidak', 1, 2),
(11, '3310349576', 'Barqah Genardo', 'Jl Batuhitam, Lampung Selatan, Lampung', 'barqahgenardo@gmail.com', '$2y$10$6jaWByjkdFOR6Xyu4XRJh.k9GMSEYEPncm2zw1g71Hl48z3.FW8Oq', '083673173566', 'pic', 'keluar', 'tidak', NULL, NULL),
(12, '3324563913', 'Reza Elfa', 'Jl Bundaran, Magelang, Jawa Tengah', 'rezaelfa342@gmail.com', '$2y$10$.0..UM2bKww6qI1vMfDt..Xl/JpiNAdNsZAFJRtZuG8P9uXq06NQa', '085621452644', 'pic', 'keluar', 'tidak', NULL, NULL),
(13, '3310349753', 'Joan Siregar', 'Jl Tanahkula, Tarutung, Sumatera Utara', 'joansiregar234@gmail.com', '$2y$10$HyJ/Uj1F821Jz/Ig8gPiFe4cMCV6pH4M4YYYS2nThq97aCCL1/.5u', '083673176541', 'client', 'keluar', 'tidak', NULL, NULL),
(14, '3135436471', 'Daisy Gumilang', 'Jl R.Supratman, Bogor, Jawa Barat', 'daisygumilang123@gmail.com', '$2y$10$Vp1m3vvac4Q5WM9Ugo/ptuoOJa93xJHNOzazA1urqVMONmaJNGcDC', '085621452642', 'client', 'keluar', 'tidak', NULL, NULL),
(15, '3310349783', 'Olivia Aulia Ardi', 'Jl Bawean, Temanggung, Jawa Tengah', 'oliviaardi@gmail.com', '$2y$10$m9o2XtmCrFZik8v8E6VZ7ui/4RPMKiHmr1.AjLRbFaPZtAMyRq/Tu', '083673176442', 'client', 'keluar', 'tidak', NULL, NULL),
(16, '3331347632', 'Fahmi Ulil', 'Jl Banjarsari, Kendal, Jawa Tengah', 'fahmiulil123@gmail.com', '$2y$10$lRXJprMzljrUo13nZzURnehS6BscvvUv6zP3OsvKRsJ2sUiFkQYBW', '085292314526', 'non_fl', 'keluar', 'tidak', 1, NULL),
(17, '3367415573', 'Naryoko', 'Jl Bidjen Katamso, Kudus, Jawa Tengah', 'naryoko123@gmail.com', '$2y$10$X/uI0B.ygkYtK14gh/KZnupIUMbqZcMkm8i10D9zXTc3vgqx6PCeW', '083673178721', 'non_fl', 'keluar', 'tidak', 2, NULL),
(18, '3334147561', 'Wahyu Priadi', 'Jl Banaran, Jakarta Timur, Jakarta', 'wahyupriadi123@gmail.com', '$2y$10$v2dhd8tEOhB3SJqjedUcHObVP3qLZx/S/ML6pN10F.VfWrhs03TNy', '085621452651', 'non_fl', 'keluar', 'tidak', 2, NULL);
...
--
ALTER TABLE `tb_user`
  ADD CONSTRAINT `fk_fl_shift` FOREIGN KEY (`id_shift`) REFERENCES `tb_shift` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
