...
class Product extends REST_Controller {
	...
	function index_get() {
		if($this->get('id_client')==NULL){
			...
			$q = "SELECT o.id_produk, o.kode_produk, o.nama_produk, o.foto, o.id_client, a.nama AS nama_client FROM tb_produk o LEFT JOIN tb_user a ON o.id_client=a.id_user WHERE o.id_client = '".$this->get('id_client')."' AND o.deleted='0' ORDER BY `o`.`nama_produk` ASC";
			$get_data = $this->db->query($q)->result();
			if($get_data==NULL){
				echo "no_data";
			}else{
