...
class Report extends REST_Controller {
    ...
    function index_get() {
		if($this->get('id_laporan')==NULL){
			$q = "SELECT a.id AS id_laporan,a.tgl_laporan,b.nama_outlet,a.kode_produk,a.kondisi,a.jumlah,a.foto,a.keterangan,a.tgl_masuk,a.tgl_kadaluarsa FROM tb_lapor_fl a LEFT JOIN tb_outlet b ON a.id_outlet=b.id_outlet WHERE a.id='".$this->get('id_laporan')."' AND a.nik_fl='".$this->get('id_fl')."'";
