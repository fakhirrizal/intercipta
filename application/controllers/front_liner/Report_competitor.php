...
class Report_competitor extends REST_Controller {
	...
	function index_get() {
		if($this->get('id_fl')!=NULL){
			$q = "SELECT a.id_report_competitor,b.nama,a.foto,a.deskripsi,a.waktu FROM tb_report_competitor a LEFT JOIN tb_user b ON a.id_user=b.id_user WHERE a.id_user='".$this->get('id_fl')."'";
